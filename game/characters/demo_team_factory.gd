...
static func create_player_team() -> BaseballTeamData:
	...
	var catcher := _player("demo_catcher", "Catcher", "C", "catcher", "water")
	catcher.defense = 70
	team.add_player(catcher, true)
...
static func create_rival_team() -> BaseballTeamData:
	...
	var pitcher := _player("rival_sr", "Rival Ace", "P", "pitcher", "ice")
	pitcher.pitch = 70
	pitcher.control = 64
	pitcher.defense = 60
	pitcher.stamina = 75
	...
	team.add_player(_player("rival_catcher", "Rival Catcher", "C", "catcher", "water"), false)
	team.add_player(_player("rival_1b", "Rival First", "1B", "defender", "nature"), false)
	team.add_player(_player("rival_2b", "Rival Second", "2B", "contact", "light"), false)
	team.add_player(_player("rival_3b", "Rival Third", "3B", "power", "fire"), false)
	team.add_player(_player("rival_ss", "Rival Short", "SS", "contact", "lightning"), false)
	team.add_player(_player("rival_lf", "Rival Left", "LF", "defender", "ice"), false)
	team.add_player(_player("rival_cf", "Rival Center", "CF", "runner", "nature"), false)
	team.add_player(_player("rival_rf", "Rival Right", "RF", "power", "darkness"), false)
