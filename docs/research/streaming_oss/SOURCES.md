...
| MediaPipe | https://github.com/google-ai-edge/mediapipe | Apache-2.0 | Pipeline de visión y Face Mesh/landmarks | Dependencia actual del bridge |
...
| obsws-python | https://github.com/aatikturk/obsws-python | GPL-3.0 | Cliente Python para OBS WebSocket 5.x | Dependencia opcional actual |
...
Los metadatos del repositorio consultado actualmente identifican MediaPipe como Apache-2.0 y `aatikturk/obsws-python` como GPL-3.0. La licencia efectiva para una distribución debe comprobarse además contra la versión concreta instalada.
